...
async def create_request(request: schemas.v1.RequestCreate, project_id: UUID, test_run_id: UUID, test_id: UUID,
...
async def update_request(request: schemas.v1.Request, project_id: UUID, test_run_id: UUID, test_id: UUID, request_id: UUID,
                         response: Response, requests: dal.Requests = Depends(dal.get_requests)):
    ...
    try:
        ...
        try:
            await requests.create(schemas.v1.RequestCreate.parse_obj(request))
...
async def update_request_fields(request: schemas.v1.Request, project_id: UUID, test_run_id: UUID, test_id: UUID, request_id: UUID,
...
@router.get('/projects/{project_id}/test-runs/{test_run_id}/tests/{test_id}/requests/{request_id}', response_model=schemas.v1.Request)
...
@router.get('/projects/{project_id}/test-runs/{test_run_id}/tests/{test_id}/requests', response_model=list[
    schemas.v1.Request])
